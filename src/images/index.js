...
export const Logo250WShadow = require('./logo-idea1-250px-whiteshadow.png');
export const BioLinkDesign = require('./biolink-new-2.png');
export const Mockup1 = require('./mockup-1.jpg');
export const Spartan = require('./spartan-plumbing.png');
